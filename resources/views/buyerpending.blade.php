...
<html lang="{{ app()->getLocale() }}">
    <head>
	 <title>Your Pending Transactions</title>
...
<div id="app" class="container">
	...
	<!--Begin header class DIV-->
	 ...
	 <!--End of Creating Menu Icon from scatch with Css-->
		...
		<span v-for="tracker in pendingTrackers">
		<buyer-pending  :id="tracker.id" :seller="tracker.seller_id" :shop="tracker.shop_id"></buyer-pending>
		</span>
	...
	<!--End main-categories class div-->
		...
		<div id="pending-home" class="transaction-button" @click="homeUrl()">
		<div>
		
		<img id="pending-home-avatar" class="transaction-avatar"  width="30px" height="auto" src="{{Storage::url('public/icons/home.png')}}"/>
		</div>
